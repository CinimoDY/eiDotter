...
<DosFigure
  ...
  ariaLabel="Eidotter wordmark in ASCII amber phosphor."
/>
```
...
<DosFigure
  subject={<PlanetSvg />}
  ariaLabel="Annotated planet study."
  pins={[
...
- Pass `ariaLabel` to describe the subject
...
| `ariaLabel` | `string` | — | Accessible label for the figure |
