...
export const TypographyFontFamilyPrimary = ["Flexi IBM VGA True", "monospace"]; // Flexi IBM VGA True v2 — vector remake of IBM VGA BIOS font, aspect-corrected (CC BY-SA 4.0). The `monospace` fallback preserves terminal aesthetic when @font-face loading fails (strict CSP, web-fonts disabled, etc.). Consumers wanting fail-loud diagnostic behavior can use `font-dos-fallback` instead, which is intentionally bare.
