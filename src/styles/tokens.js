...
export const ColorSemanticTextBrandBright = "#fdca9f"; // DMNC-1059: bright-amber brand emphasis text — hover/active peaks (e.g. Checkbox hover glyph, link-button hover, Button :active label). Brand-locked amber across themes. NOTE: there is intentionally no `text.brandDim` — dim amber TEXT uses `text.tertiary` (also amberDim); only `background`/`border` carry a `brandDim`.
...
export const ColorSemanticBackgroundBrandBright = "#fdca9f"; // DMNC-1059: bright-amber brand emphasis surface — hover/active/selected peaks (e.g. primary button :active fill, active TimelineNode marker, InlineLink :active). Brand-locked amber across themes.
export const ColorSemanticBackgroundBrandDim = "#9a5700"; // DMNC-1059: dim-amber brand surface — low-emphasis fills/headers (e.g. Card header, timeline axis, default TimelineNode marker). Brand-locked amber across themes.
...
export const ColorSemanticBorderBrandBright = "#fdca9f"; // DMNC-1059: bright-amber brand emphasis border — hover/active/selected peaks (e.g. primary button :active, active TimelineNode marker). Brand-locked amber across themes.
export const ColorSemanticBorderBrandDim = "#9a5700"; // DMNC-1059: dim-amber brand border — low-emphasis markers (e.g. default TimelineNode marker). Brand-locked amber across themes.
