import{j as o}from"./jsx-runtime-D_zvdyIk.js";import{r as l}from"./iframe-Cnx5oUV1.js";const a=l.forwardRef(({variant:e="default",className:r="",disabled:t,...n},s)=>{const i=["input",`input--${e}`,t&&"input--disabled",r].filter(Boolean).join(" ");return o.jsx("input",{ref:s,className:i,disabled:t,"aria-invalid":e==="error",...n})});a.displayName="Input";a.__docgenInfo={description:`DOS-styled Input component with authentic terminal aesthetics\r
\r
Features:\r
