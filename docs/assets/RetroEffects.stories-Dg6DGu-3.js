import{j as e}from"./jsx-runtime-D_zvdyIk.js";import{r as R,R as T}from"./iframe-BU4rT9RF.js";import{c as de}from"./cn-CvUv5FIJ.js";import{c as pe}from"./registry-CyM9n0D0.js";import"./preload-helper-Dp1pzeXC.js";const n=({scanlines:r=!0,glow:c=!0,flicker:d=!0,bloom:j=!1,powered:o=!0,intensity:i=1,className:f,onPowerStateChange:t,onPowerOn:k,onPowerOff:E})=>{const O=R.useRef(o),[s,C]=R.useState(o?"on":"off");R.useEffect(()=>{const l=O.current;if(O.current=o,l!==o){const F=o?"powering-on":"powering-off";C(F),t==null||t(F)}},[o,t]);const S=()=>{s==="powering-on"?(C("on"),t==null||t("on"),k==null||k()):s==="powering-off"&&(C("off"),t==null||t("off"),E==null||E())},ie=l=>{l.animationName!=="retro-power-on"&&l.animationName!=="retro-power-off"||S()},le=l=>{l.propertyName==="opacity"&&(s!=="powering-on"&&s!=="powering-off"||S())},ce={"--retro-intensity":i},fe=s!=="off";return e.jsx("div",{className:de("fixed inset-0 pointer-events-none z-[9999]","eidotter-retro-effects",s==="powering-off"&&"eidotter-retro-effects--powering-off",s==="powering-on"&&"eidotter-retro-effects--powering-on",s==="off"&&"eidotter-retro-effects--off",f),style:ce,"aria-hidden":"true",onAnimationEnd:ie,onTransitionEnd:le,children:fe&&e.jsxs(e.Fragment,{children:[r&&e.jsx("div",{className:"eidotter-retro-effects__scanlines"}),c&&e.jsx("div",{className:"eidotter-retro-effects__glow"}),d&&e.jsx("div",{className:"eidotter-retro-effects__flicker"}),j&&e.jsx("div",{className:"eidotter-retro-effects__bloom"})]})})};n.__docgenInfo={description:`CRT Monitor Effects component for authentic DOS terminal aesthetics
...
}`,...(P=(N=p.parameters)==null?void 0:N.docs)==null?void 0:P.source}}};var B,W,_;m.parameters={...m.parameters,docs:{...(B=m.parameters)==null?void 0:B.docs,source:{originalSource:`{
  args: {
    scanlines: true,
    glow: false,
    flicker: false,
...
}`,...(_=(W=m.parameters)==null?void 0:W.docs)==null?void 0:_.source}}};var q,A,z;u.parameters={...u.parameters,docs:{...(q=u.parameters)==null?void 0:q.docs,source:{originalSource:`{
  args: {
    scanlines: false,
    glow: true,
    flicker: false,
...
}`,...(z=(A=u.parameters)==null?void 0:A.docs)==null?void 0:z.source}}};var I,L,V;g.parameters={...g.parameters,docs:{...(I=g.parameters)==null?void 0:I.docs,source:{originalSource:`{
  args: {
    scanlines: true,
    glow: true,
    flicker: true,
...
}`,...(V=(L=g.parameters)==null?void 0:L.docs)==null?void 0:V.source}}};var M,G,$;y.parameters={...y.parameters,docs:{...(M=y.parameters)==null?void 0:M.docs,source:{originalSource:`{
  args: {
    scanlines: true,
    glow: true,
    flicker: true,
...
}`,...(ae=(se=v.parameters)==null?void 0:se.docs)==null?void 0:ae.source}}};const ve=["Default","ScanlinesOnly","GlowOnly","SubtleEffects","IntenseEffects","NoEffects","WithBloom","PowerCycle","PoweredOff","WithCallbacks"];export{p as Default,u as GlowOnly,y as IntenseEffects,x as NoEffects,w as PowerCycle,b as PoweredOff,m as ScanlinesOnly,g as SubtleEffects,h as WithBloom,v as WithCallbacks,ve as __namedExportsOrder,be as default};
