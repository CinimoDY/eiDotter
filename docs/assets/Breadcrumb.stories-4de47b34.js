import{j as e}from"./jsx-runtime-bb4eca5c.js";import"./index-9ab4f09c.js";import"./_commonjsHelpers-725317a4.js";const a=({trail:t=[],currentLabel:M,showBackArrow:V=!0,separator:b="/",linkComponent:h,className:I=""})=>{const F=["breadcrumb",I].filter(Boolean).join(" "),W=(r,s)=>{const n=e.jsxs(e.Fragment,{children:[V&&s&&e.jsx("span",{className:"breadcrumb__back-arrow","aria-hidden":"true",children:"<"}),e.jsx("span",{children:r.label})]});return h?e.jsx(h,{href:r.href,className:"breadcrumb__link",children:n}):e.jsx("a",{href:r.href,className:"breadcrumb__link",children:n})};return e.jsx("nav",{"aria-label":"Breadcrumb",className:F,children:e.jsxs("ol",{className:"breadcrumb__list",children:[t.map((r,s)=>{const n=s===t.length-1,$=s<t.length-1;return e.jsxs("li",{className:"breadcrumb__item",children:[W(r,n),$&&e.jsx("span",{className:"breadcrumb__separator","aria-hidden":"true",children:b})]},`${r.href}-${r.label}`)}),t.length>0&&e.jsx("li",{className:"breadcrumb__item",children:e.jsx("span",{className:"breadcrumb__separator","aria-hidden":"true",children:b})}),e.jsx("li",{className:"breadcrumb__item breadcrumb__item--current","aria-current":"page",children:e.jsx("span",{className:"breadcrumb__current",children:M})})]})})};a.__docgenInfo={description:`DOS-styled Breadcrumb navigation component\r
\r
Features:\r
- Configurable trail items\r
- Optional back arrow on last trail item\r
- Custom separator support\r
- Framework-agnostic (works with any router)\r
- WCAG 2.1 AA compliant\r
- DOS-authentic styling with CGA colors`,methods:[],displayName:"Breadcrumb",props:{trail:{required:!1,tsType:{name:"Array",elements:[{name:"BreadcrumbItem"}],raw:"BreadcrumbItem[]"},description:"Array of breadcrumb items forming the trail",defaultValue:{value:"[]",computed:!1}},currentLabel:{required:!0,tsType:{name:"string"},description:"Current page label (not a link)"},showBackArrow:{required:!1,tsType:{name:"boolean"},description:"Show back arrow on the last trail item",defaultValue:{value:"true",computed:!1}},separator:{required:!1,tsType:{name:"string"},description:"Custom separator character",defaultValue:{value:"'/'",computed:!1}},linkComponent:{required:!1,tsType:{name:"ReactComponentType",raw:`React.ComponentType<{\r
  href: string;\r
  className?: string;\r
