import{j as e}from"./jsx-runtime-D_zvdyIk.js";const a=({trail:t=[],currentLabel:M,showBackArrow:V=!0,separator:b="/",linkComponent:h,className:I=""})=>{const F=["breadcrumb",I].filter(Boolean).join(" "),W=(r,s)=>{const n=e.jsxs(e.Fragment,{children:[V&&s&&e.jsx("span",{className:"breadcrumb__back-arrow","aria-hidden":"true",children:"<"}),e.jsx("span",{children:r.label})]});return h?e.jsx(h,{href:r.href,className:"breadcrumb__link",children:n}):e.jsx("a",{href:r.href,className:"breadcrumb__link",children:n})};return e.jsx("nav",{"aria-label":"Breadcrumb",className:F,children:e.jsxs("ol",{className:"breadcrumb__list",children:[t.map((r,s)=>{const n=s===t.length-1,G=s<t.length-1;return e.jsxs("li",{className:"breadcrumb__item",children:[W(r,n),G&&e.jsx("span",{className:"breadcrumb__separator","aria-hidden":"true",children:b})]},`${r.href}-${r.label}`)}),t.length>0&&e.jsx("li",{className:"breadcrumb__item",children:e.jsx("span",{className:"breadcrumb__separator","aria-hidden":"true",children:b})}),e.jsx("li",{className:"breadcrumb__item breadcrumb__item--current","aria-current":"page",children:e.jsx("span",{className:"breadcrumb__current",children:M})})]})})};a.__docgenInfo={description:`DOS-styled Breadcrumb navigation component
...
If not provided, uses regular anchor tags`},className:{required:!1,tsType:{name:"string"},description:"Additional CSS class name",defaultValue:{value:"''",computed:!1}}}};const X={title:"Components/Breadcrumb",component:a,parameters:{layout:"centered"},tags:["autodocs"],argTypes:{trail:{control:"object",description:"Array of breadcrumb trail items"},currentLabel:{control:"text",description:"Current page label"},showBackArrow:{control:"boolean",description:"Show back arrow on last trail item"},separator:{control:"text",description:"Custom separator character"}}},o={args:{trail:[{href:"/",label:"Home"},{href:"/projects",label:"Projects"}],currentLabel:"Eidotter"}},l={args:{trail:[{href:"/",label:"Home"}],currentLabel:"About"}},c={args:{trail:[{href:"/",label:"Home"},{href:"/projects",label:"Projects"},{href:"/projects/design-systems",label:"Design Systems"}],currentLabel:"Eidotter"}},i={args:{trail:[],currentLabel:"Home"}},d={args:{trail:[{href:"/",label:"Home"},{href:"/projects",label:"Projects"}],currentLabel:"Eidotter",showBackArrow:!1}},m={args:{trail:[{href:"/",label:"C:"},{href:"/projects",label:"Projects"}],currentLabel:"Readme.txt",separator:"\\"}},p={args:{trail:[{href:"/",label:"C:"},{href:"/dos",label:"DOS"}],currentLabel:"COMMAND.COM",separator:"\\",showBackArrow:!1}},u={render:()=>e.jsxs("div",{style:{display:"flex",flexDirection:"column",gap:"24px"},children:[e.jsxs("div",{children:[e.jsx("div",{style:{color:"var(--color-semantic-text-disabled)",fontSize:"10px",marginBottom:"8px",textTransform:"uppercase",letterSpacing:"0.1em"},children:"Default"}),e.jsx(a,{trail:[{href:"/",label:"Home"},{href:"/projects",label:"Projects"}],currentLabel:"Eidotter"})]}),e.jsxs("div",{children:[e.jsx("div",{style:{color:"var(--color-semantic-text-disabled)",fontSize:"10px",marginBottom:"8px",textTransform:"uppercase",letterSpacing:"0.1em"},children:"DOS Path Style"}),e.jsx(a,{trail:[{href:"/",label:"C:"},{href:"/dos",label:"DOS"}],currentLabel:"AUTOEXEC.BAT",separator:"\\",showBackArrow:!1})]}),e.jsxs("div",{children:[e.jsx("div",{style:{color:"var(--color-semantic-text-disabled)",fontSize:"10px",marginBottom:"8px",textTransform:"uppercase",letterSpacing:"0.1em"},children:"Single Level"}),e.jsx(a,{trail:[{href:"/",label:"Home"}],currentLabel:"Contact"})]})]})};var f,g,x;o.parameters={...o.parameters,docs:{...(f=o.parameters)==null?void 0:f.docs,source:{originalSource:`{
  args: {
    trail: [{
      href: '/',
      label: 'Home'
...
}`,...(A=(k=i.parameters)==null?void 0:k.docs)==null?void 0:A.source}}};var L,N,_;d.parameters={...d.parameters,docs:{...(L=d.parameters)==null?void 0:L.docs,source:{originalSource:`{
  args: {
    trail: [{
      href: '/',
      label: 'Home'
...
}`,...(_=(N=d.parameters)==null?void 0:N.docs)==null?void 0:_.source}}};var D,T,O;m.parameters={...m.parameters,docs:{...(D=m.parameters)==null?void 0:D.docs,source:{originalSource:`{
  args: {
    trail: [{
      href: '/',
      label: 'C:'
...
}`,...(O=(T=m.parameters)==null?void 0:T.docs)==null?void 0:O.source}}};var E,H,P;p.parameters={...p.parameters,docs:{...(E=p.parameters)==null?void 0:E.docs,source:{originalSource:`{
  args: {
    trail: [{
      href: '/',
      label: 'C:'
...
}`,...(P=(H=p.parameters)==null?void 0:H.docs)==null?void 0:P.source}}};var R,q,z;u.parameters={...u.parameters,docs:{...(R=u.parameters)==null?void 0:R.docs,source:{originalSource:`{
  render: () => <div style={{
    display: 'flex',
...
}`,...(z=(q=u.parameters)==null?void 0:q.docs)==null?void 0:z.source}}};const $=["Default","SingleLevel","DeepNavigation","NoTrail","WithoutBackArrow","CustomSeparator","DOSPath","AllVariants"];export{u as AllVariants,m as CustomSeparator,p as DOSPath,c as DeepNavigation,o as Default,i as NoTrail,l as SingleLevel,d as WithoutBackArrow,$ as __namedExportsOrder,X as default};
