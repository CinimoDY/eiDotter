import{j as e}from"./jsx-runtime-bb4eca5c.js";import"./index-9ab4f09c.js";import"./_commonjsHelpers-725317a4.js";const a=({variant:ce="primary",size:me="medium",type:pe="button",disabled:r=!1,loading:t=!1,children:ge,onClick:B,className:he="",fullWidth:ye=!1,...fe})=>{const ve=be=>{r||t||B==null||B(be)},Be=["button",`button--${ce}`,`button--${me}`,r&&"button--disabled",t&&"button--loading",ye&&"button--full-width",he].filter(Boolean).join(" ");return e.jsxs("button",{type:pe,className:Be,onClick:ve,disabled:r||t,"aria-disabled":r||t,...fe,children:[t&&e.jsx("span",{className:"button__loading-indicator","aria-hidden":"true",children:"█"}),e.jsx("span",{className:`button__content ${t?"button__content--loading":""}`,children:ge})]})};a.__docgenInfo={description:`DOS-styled Button component with authentic terminal aesthetics\r
\r
Features:\r
...
}`,...(ae=(ee=h.parameters)==null?void 0:ee.docs)==null?void 0:ae.source}}};var te,re,ne;y.parameters={...y.parameters,docs:{...(te=y.parameters)==null?void 0:te.docs,source:{originalSource:`{
  render: () => <div style={{
    display: 'flex',
    gap: '12px',
    alignItems: 'center',
...
}`,...(ne=(re=y.parameters)==null?void 0:re.docs)==null?void 0:ne.source}}};var se,oe,le;f.parameters={...f.parameters,docs:{...(se=f.parameters)==null?void 0:se.docs,source:{originalSource:`{
  render: () => <div style={{
    display: 'flex',
    gap: '12px',
    flexWrap: 'wrap'
...
}`,...(de=(ue=v.parameters)==null?void 0:ue.docs)==null?void 0:de.source}}};const we=["Default","Primary","Secondary","Ghost","Link","Small","Medium","Large","Disabled","Loading","FullWidth","AllVariants","AllSizes","AllStates","FormButtons"];export{y as AllSizes,f as AllStates,h as AllVariants,n as Default,m as Disabled,v as FormButtons,g as FullWidth,l as Ghost,c as Large,i as Link,p as Loading,d as Medium,s as Primary,o as Secondary,u as Small,we as __namedExportsOrder,Le as default};
