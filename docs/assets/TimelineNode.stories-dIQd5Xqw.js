import{j as e}from"./jsx-runtime-D_zvdyIk.js";import{c as te}from"./registry-DmuPb2r9.js";const a=({shape:X="circle",variant:Y="default",isActive:f=!1,label:l,labelPosition:s="left",size:Z="medium",className:ee="",onClick:i,...ae})=>{const le=["timeline-node",`timeline-node--${X}`,`timeline-node--${Y}`,`timeline-node--${Z}`,`timeline-node--label-${s}`,f&&"timeline-node--active",i&&"timeline-node--interactive",ee].filter(Boolean).join(" "),ie=()=>{i&&i()},se=b=>{i&&(b.key==="Enter"||b.key===" ")&&(b.preventDefault(),i())};return e.jsxs("div",{className:le,onClick:ie,onKeyDown:se,role:i?"button":void 0,tabIndex:i?0:void 0,"aria-pressed":i?f:void 0,...ae,children:[l&&s==="left"&&e.jsx("span",{className:"timeline-node__label timeline-node__label--left",children:l}),l&&s==="top"&&e.jsx("span",{className:"timeline-node__label timeline-node__label--top",children:l}),e.jsx("span",{className:"timeline-node__marker","aria-hidden":"true"}),l&&s==="right"&&e.jsx("span",{className:"timeline-node__label timeline-node__label--right",children:l}),l&&s==="bottom"&&e.jsx("span",{className:"timeline-node__label timeline-node__label--bottom",children:l})]})};a.__docgenInfo={description:`TimelineNode - Axis marker for timeline/stepper interfaces
...
}`,...(C=(V=c.parameters)==null?void 0:V.docs)==null?void 0:C.source}}};var L,M,R;m.parameters={...m.parameters,docs:{...(L=m.parameters)==null?void 0:L.docs,source:{originalSource:`{
  render: () => <div style={{
    display: 'flex',
    gap: '48px',
    alignItems: 'center'
...
}`,...(R=(M=m.parameters)==null?void 0:M.docs)==null?void 0:R.source}}};var $,B,E;p.parameters={...p.parameters,docs:{...($=p.parameters)==null?void 0:$.docs,source:{originalSource:`{
  render: () => <div style={{
    display: 'flex',
    gap: '32px',
    alignItems: 'center'
...
}`,...(E=(B=p.parameters)==null?void 0:B.docs)==null?void 0:E.source}}};var F,O,J;u.parameters={...u.parameters,docs:{...(F=u.parameters)==null?void 0:F.docs,source:{originalSource:`{
  render: () => <div style={{
    display: 'flex',
...
}`,...(J=(O=u.parameters)==null?void 0:O.docs)==null?void 0:J.source}}};var K,G,U;v.parameters={...v.parameters,docs:{...(K=v.parameters)==null?void 0:K.docs,source:{originalSource:`{
  render: () => <div style={{
    display: 'flex',
    alignItems: 'center',
    gap: '0'
