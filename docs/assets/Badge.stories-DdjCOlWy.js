import{j as e}from"./jsx-runtime-D_zvdyIk.js";const a=({variant:ae="default",size:re="medium",dot:f=!1,children:se,className:ne="",...te})=>{const ie=["badge",`badge--${ae}`,`badge--${re}`,f&&"badge--with-dot",ne].filter(Boolean).join(" ");return e.jsxs("span",{className:ie,...te,children:[f&&e.jsx("span",{className:"badge__dot","aria-hidden":"true"}),e.jsx("span",{className:"badge__content",children:se})]})};a.__docgenInfo={description:`DOS-styled Badge component for status indicators, labels, and tags\r
\r
Features:\r
...
}`,...(q=(R=c.parameters)==null?void 0:R.docs)==null?void 0:q.source}}};var P,k,G;o.parameters={...o.parameters,docs:{...(P=o.parameters)==null?void 0:P.docs,source:{originalSource:`{
  args: {
    dot: true,
    children: 'Active'
  }
}`,...(G=(k=o.parameters)==null?void 0:k.docs)==null?void 0:G.source}}};var H,L,$;u.parameters={...u.parameters,docs:{...(H=u.parameters)==null?void 0:H.docs,source:{originalSource:`{
  render: () => <div style={{
    display: 'flex',
    gap: '12px',
    flexWrap: 'wrap'
...
}`,...($=(L=u.parameters)==null?void 0:L.docs)==null?void 0:$.source}}};var F,J,K;p.parameters={...p.parameters,docs:{...(F=p.parameters)==null?void 0:F.docs,source:{originalSource:`{
  render: () => <div style={{
    display: 'flex',
    gap: '12px',
    alignItems: 'center'
...
}`,...(ee=(Z=g.parameters)==null?void 0:Z.docs)==null?void 0:ee.source}}};const ce=["Default","Success","Warning","Error","Info","Accent","Small","Medium","WithDot","AllVariants","AllSizes","AllWithDots","RealWorldExamples"];export{l as Accent,p as AllSizes,u as AllVariants,m as AllWithDots,r as Default,t as Error,i as Info,c as Medium,g as RealWorldExamples,d as Small,s as Success,n as Warning,o as WithDot,ce as __namedExportsOrder,de as default};
