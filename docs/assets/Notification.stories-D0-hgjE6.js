import{j as e}from"./jsx-runtime-D_zvdyIk.js";import{r as se}from"./iframe-DuFfgGUU.js";import{$ as N}from"./Button-CBQkCg2v.js";import{c as k}from"./cn-CvUv5FIJ.js";import{I as j}from"./Icon-BUHYQ9Cx.js";import{P as re}from"./Progress-ZfesRG6R.js";import{u as ae}from"./useAnimatedDismiss-CzgleG2o.js";import"./preload-helper-Dp1pzeXC.js";import"./useFocusRing-BtFWDqtK.js";import"./Hidden-D7HVVFJk.js";import"./usePress-ChW8_10P.js";import"./index-CjOovKeQ.js";import"./index-BOb-1P7R.js";import"./prefersReducedMotion-lKH2k1Yv.js";const te={primary:"Info",gray:"Info",success:"Done",warning:"Warning",error:"Error"},o=({type:s="primary",title:f,children:g,actions:y,onClose:r,avatar:i,image:b,progress:w,progressLabel:C,duration:h,showIcon:K=!0,className:Q})=>{const{isClosing:X,triggerClose:x,handleAnimationEnd:Z}=ae("notification-exit",r);se.useEffect(()=>{if(h==null||!r)return;const a=setTimeout(()=>x(),h);return()=>clearTimeout(a)},[h,r,x]);const v=K&&!i,ee=w!=null;return e.jsxs("div",{className:k("w-full max-w-[400px]","font-dos text-dos-text-sm","border border-dos-border-default rounded-dos-base","eidotter-notification",`eidotter-notification--${s}`,X&&"eidotter-notification--closing",Q),onAnimationEnd:Z,role:s==="error"?"alert":"status","data-type":s,children:[b&&e.jsx("div",{className:"eidotter-notification__image",children:b}),e.jsxs("div",{className:"flex flex-row gap-4 p-4",children:[i&&e.jsx("div",{className:"eidotter-notification__avatar flex-shrink-0",children:i}),v&&e.jsx("div",{className:"eidotter-notification__icon",children:e.jsx(j,{name:te[s]||"Info",size:"S","aria-label":`${s} notification`})}),e.jsxs("div",{className:k("flex-1 flex flex-col gap-3 min-w-0",r&&!v&&!i&&"pr-8"),children:[(f||g)&&e.jsxs("div",{className:"flex flex-col gap-1",children:[f&&e.jsx("div",{className:"eidotter-notification__title font-dos leading-[140%]",children:f}),g&&e.jsx("div",{className:"eidotter-notification__text font-dos leading-[140%]",children:g})]}),ee&&e.jsxs("div",{className:"flex flex-col gap-1",children:[e.jsx(re,{value:w,max:100,size:"sm",fullWidth:!0,showLabel:!1}),C&&e.jsx("div",{className:"eidotter-notification__text font-dos text-dos-text-xs",children:C})]}),y&&y.length>0&&e.jsx("div",{className:"flex flex-row gap-3",children:y.map((a,oe)=>e.jsxs(N,{className:"eidotter-notification__action",onPress:a.onClick,children:[a.label,a.icon]},oe))})]}),r&&e.jsx(N,{className:"eidotter-notification__close",onPress:x,"aria-label":"Close notification",children:e.jsx(j,{name:"Close",size:"S"})})]})]})};o.__docgenInfo={description:`DOS-styled Notification (toast) with V.37 design: layered amber glow,
