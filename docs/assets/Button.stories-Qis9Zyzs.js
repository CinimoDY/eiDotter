...
}`,...(pr=(dr=f.parameters)==null?void 0:dr.docs)==null?void 0:pr.source}}};const fr=["Default","Primary","Secondary","Ghost","Link","Small","Medium","Large","Disabled","Loading","FullWidth","AllVariants","AllSizes","AllStates","PhosphorStates","FormButtons"];export{g as AllSizes,y as AllStates,u as AllVariants,a as Default,d as Disabled,f as FormButtons,m as FullWidth,n as Ghost,c as Large,s as Link,p as Loading,i as Medium,x as PhosphorStates,t as Primary,o as Secondary,l as Small,fr as __namedExportsOrder,xr as default};
